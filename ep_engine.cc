...
ENGINE_ERROR_CODE EventuallyPersistentEngine::initialize(const char* config) {
    ...
    StoredValue::setMutationMemoryThreshold(configuration.getMutationMemThresold());
    ...
    BackFillVisitor::setResidentItemThreshold(configuration.getBfResidentThresold());
